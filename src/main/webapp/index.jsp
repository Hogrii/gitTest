...
<head>
    ...
    <style>
    /*
    내가 사랑하는 혜주 오늘도 너무 고마워 덕분에 깃에 대해서 알아가고 있어.
    */
        /* 전체 설정 css start */
        :root {
            --color1: #3d3d3d;
    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="exhibition_con">
                <div class="ex_title">전시회 안내 Exhibition&nbsp
                    <a href=""><span style="color:black"><i class="fas fa-angle-double-right"></i></span></a>
                </div>
                <div class="ex_intro">
                    <div class="ex_intro_top">
                        <div><a href=""><img src="img/main_ex_intro.png" width="100%" height="100%"></a></div>
                        <div><a href=""><img src="img/main_ex_intro.png" width="100%" height="100%"></a></div>
                        <div><a href=""><img src="img/main_ex_intro.png" width="100%" height="100%"></a></div>
                        <div><a href=""><img src="img/main_ex_intro.png" width="100%" height="100%"></a></div>
                    </div>
            ...
            <!-- 별점, 순위 파트 -->
            <div class="rank_con">
                <div class="rank_title">랭킹 Ranking </div>
                <div class="rank_img">
            ...
            <!-- 이벤트 파트 -->
            <div class="evnet_con">
                <div class="event_title">이벤트 Event&nbsp
                    <a href=""><span style="color:black"><i class="fas fa-angle-double-right"></i></span></a>
                </div>
                <div class="event_img">
            ...
            <div class="top">
                <button type="button" class="btn btn-danger">
                    <a id="arrow-top" style="color:white" href=""><i class="fas fa-arrow-up fa-2x"></i> </a>
                </button>
            </div>
